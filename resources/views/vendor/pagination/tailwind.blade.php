                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="z-10 relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-indigo-700 bg-indigo border border-indigo-300 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
